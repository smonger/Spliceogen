	...
	public class mergeOutput {
	    ...
	    public static void main (String[] args) {
	        ...
	        try {
	            ...
	            //File file = new File("/home/steven/Documents/Work/admin/Spliceogen/mergeInput.txt");         
	            ...
	            //while ((s = br.readLine()) != null) {	            
	                ...
	                if(nextVariant && !prevID[4].equals("GENE")) {
	                    ...
	                    int[] phase = findNearestSpliceSites(prevID, donStart, accStart, donEnd, accEnd, strand);
	    ...
	    public static int[] findNearestSpliceSites( String[] prevID, int[] donStart, int[] accStart, int[] donEnd, int[] accEnd, String strand) {
	        int startPos = Integer.parseInt(prevID[1]);
	        //prevDon, nextDon, prevAcc, nextAcc
	        int[] phase = {-99999, Integer.MAX_VALUE, -99999, Integer.MAX_VALUE};
	        int i = 0;
	        //pos
	        if (strand.equals("pos")) {
	        ...
	        //output distance to sites instead of position
	        for (int j=0; j<4; j++) {
	        	if (phase[j]>10000000) {
	        		phase[j] = -999;
	        	}
